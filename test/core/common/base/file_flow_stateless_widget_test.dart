...
class _TestScreen extends FileFlowStatelessWidget {
...
void main() {
  group('FileFlowStatelessWidget lifecycle', () {
    ...
    testWidgets('onVisible fires after the first frame', (tester) async {
      ...
      // FileFlowState's onInitAsync, which suspends on an internal `await`
      // and needs an extra pump to resolve.
      await pumpApp(tester, _TestScreen(recorder));
