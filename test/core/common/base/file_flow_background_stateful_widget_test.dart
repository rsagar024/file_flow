...
class _TestScreen extends FileFlowBackgroundStatefulWidget {
...
class _TestScreenState extends FileFlowBackgroundState<_TestScreen> {
  @override
  void onInit() {
...
void main() {
  group('FileFlowBackgroundStatefulWidget/FileFlowBackgroundState lifecycle', () {
