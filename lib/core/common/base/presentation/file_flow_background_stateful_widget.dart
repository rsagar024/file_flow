...
abstract class FileFlowBackgroundStatefulWidget extends StatefulWidget {
  const FileFlowBackgroundStatefulWidget({super.key});
}

abstract class FileFlowBackgroundState<T extends FileFlowBackgroundStatefulWidget> extends State<T> with WidgetsBindingObserver {
